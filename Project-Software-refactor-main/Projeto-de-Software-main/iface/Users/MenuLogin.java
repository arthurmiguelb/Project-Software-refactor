...
public class MenuLogin{
    ...
    public void runMenuLogin(final Users user, final ArrayList<UserDo> users, final ArrayList<Community> communityList, final ArrayList<String> feedMessages){
        ...
        while(!exit2){
            ...
            invoker.executeCommand(choice, user, users, communityList, feedMessages);
        }
     }
    ...
    public void profileMenu(final Users user, final ArrayList<UserDo> users){
    ...
    public void delete_profile(final Users user, final ArrayList<UserDo> users){
        users.remove(user);
    }
